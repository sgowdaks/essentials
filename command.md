...
* `split -b 10G custom-new.tar.gz "custom-new.tar.gz.part"` -> split tar file into peices
* `cat largefile.tar.gz.part* > largefile.tar.gz` -> to reassemble splited files back
